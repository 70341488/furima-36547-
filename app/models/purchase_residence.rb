class PurchaseResidence
  ...
  attr_accessor :user_id,  :item_id,  :purchase,  :delivery_zone_id,  :building_name, :post_number,  :municipalities, :address, :phone_number, :image, :price, :item_name, :delivery_fee_id
